...
//  >CLASSES<
class Coder {
    name; // you need the property to exist in the class as a member
    music;
    age;
    lang; //Property 'music' has no initializer and is not definitely assigned in the constructor.ts(2564)
